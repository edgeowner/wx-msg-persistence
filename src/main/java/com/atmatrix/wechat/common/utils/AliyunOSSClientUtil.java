...
public class AliyunOSSClientUtil {
    ...
    public static String uploadInputStreamToOSS(String hash, InputStream inputStream, String fileName, Long fileSize) {
        String result = null;
        ObjectMetadata metadata = new ObjectMetadata();
        ...
        try {
            ...
            fileName = fileName.replace(preName, hash);
            PutObjectResult putResult = ossClient.putObject(BACKET_NAME, FOLDER + fileName, inputStream, metadata);
            log.info(MessageFormat.format("uploadInputStreamToOSS result:{0}", putResult.getETag()));
            result = fileName;
        } catch (Exception e) {
            e.printStackTrace();
            log.error("上传阿里云OSS服务器异常." + e.getMessage(), e);
    ...
    public static void main(String[] args) {
        ...
        //上传文件
        String files = "/Users/atmatrix/python-project/wechat_bot/static/0b97c36f941d34ab501a65add80d4731.jpg";
